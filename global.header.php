        ...
        <div class="global-header__content__buttons header--desktop">
            ...
            <a href="<?php echo url_for('index'); ?>">
                <?php if (strpos($_SERVER['REQUEST_URI'], '/index')): ?>
                    <svg aria-label="Home" class="_8-yf5" color="#262626" fill="#262626" height="24" role="img"
            ...
            <button class="profile-button cursor-pointer" style="position: relative;">
                ...
                <div class="menu-container">
                    <ul class="menu-bar">
                        ...
                        <li class="menu_me_wrap">
                            <a href="<?php echo url_for('saved.php'); ?>">

                                <svg aria-label="Saved" class="_ab6-" color="#262626" fill="#262626" height="16"
                                    role="img" viewBox="0 0 24 24" width="16">
                        ...
                        <li class="menu_me_wrap">
                            <a href="<?php echo url_for('settings.php'); ?>">

                                <svg aria-label="Settings" class="_ab6-" color="#262626" fill="#262626" height="16"
                                    role="img" viewBox="0 0 24 24" width="16">
                        ...
                        <li class="menu_me_wrap">
                            <a href="#">
                                ...
                                <svg aria-label="Switch accounts" class="_ab6-" color="#262626" fill="#262626"
